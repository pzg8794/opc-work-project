...
- `RegistrationTem.php` - File, 5.1 KB.
...
- `sidebar.php` - File, 261 B.
- `single.php` - File, 280 B.
- `slider.php` - File, 1.6 KB.
- `style.css` - File, 17.8 KB.
- `tag.php` - File, 276 B.
- `templatename.php` - File, 383 B.
- `templatepg.php` - File, 2.0 KB.
- `testpage.php` - File, 562 B.
- `theloop.php` - File, 706 B.
