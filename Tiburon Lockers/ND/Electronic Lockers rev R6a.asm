...
; 					bit 0 indicates Tx buffer is full
;					bit 1 indicates Tx buffer is empty
;					bit 2 indicates Rx buffer is full
;					bit 3 indicates Rx buffer is empty
;					bit 4 indicates <CR> character received
; 					bit 5 set when start of packet detected SOP1
; 					bit 6 set when SOP2 detected
; 					bit 7 Set when data reciept is allowed

		errflag		; additional flag bits
; 					bit 0 end of packet bytes don't match
; 					bit 1 checksum error
; 					bit 2 unknown command
; 					bit 6 forced error packet sent
