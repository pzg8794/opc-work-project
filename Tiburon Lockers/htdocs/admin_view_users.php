...
// Make the query:
$q = "SELECT user_id, lname, fname, email, DATE_FORMAT(registration_date, '%M %d, %Y') AS regdat, user_level FROM users ORDER BY registration_date ASC LIMIT $start, $pagerows";		
