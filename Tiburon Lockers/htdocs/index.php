...
// $url = ($_SESSION['user_level'] === 1) ? 'admin-page.php' : 'tech-page.php'; 

$ul = intval( $_SESSION['user_level']);
...
exit(); // Cancels the rest of the script.
	...
	echo '<p class="error">The User ID and password do not match our records.<br>If you need to register, click the Register button on the header menu</p>';
	}
